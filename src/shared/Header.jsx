  ...
  return (
    ...
    >
      <div className="flex justify-between items-center gap-2 w-full">
        ...
        {/* Logo */}
        <div className={`text-2xl text-blue-600 font-bold absolute top-[22px] duration-200 ${scrolled ? "-translate-y-[6px]" : "-translate-y-0"} md:top-4 left-1/2 -translate-x-1/2 md:static md:-translate-x-0`}>
          Logo
        </div>
